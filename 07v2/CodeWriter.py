...
class CodeWriter:
    ...
    def write_arithmetic(self, command):
        ...
        if command == 'add' or command == 'sub' or command == 'or' or command == 'and':
            ...
            self.dec_sp()
            self.peek('D')
            self.append_jump_to_label("positive" + "_label" + str(self._label_num), 'JGE')
            self.dec_sp()
            self.peek('A')
            self.append_address("same_sign" + "_label" + str(self._label_num))
            self.append_conditional_jump('A', 'JLT')
            ...
            self.change('D','A')
            self.append_address("same_sign" + "_label" + str(self._label_num))
            self.append_conditional_jump('D', 'JGE')
